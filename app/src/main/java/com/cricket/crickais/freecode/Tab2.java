        ...
        databaseReference1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Request request = new Request.Builder()
                        .url("https://cricket.sportmonks.com/api/v2.0/fixtures?api_token="+token+"&include=runs,tosswon,localteam,league,visitorteam,stage&filter[starts_between]=" + df.format(c.getTime()) + "," + df1.format(c1.getTime()))
                        .get().build();
